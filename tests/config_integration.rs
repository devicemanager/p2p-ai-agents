...
async fn test_config_defaults() {
    ...
    assert!(config.storage_path.to_string_lossy().contains(".p2p-ai-agents"));
...
async fn test_environment_variable_overrides() {
    ...
    env::set_var("P2P_BOOTSTRAP_NODES", "/ip4/1.2.3.4/tcp/9000,/ip4/5.6.7.8/tcp/9001");
...
async fn test_config_serialization_roundtrip() {
    ...
    assert_eq!(loaded.health_check_interval_secs, original.health_check_interval_secs);

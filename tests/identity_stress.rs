...
mod identity_stress_tests {
    ...
    async fn test_1000_restart_consistency() {
        ...
        let original = p2p_ai_agents::core::identity::storage::load_or_create_identity_at(
            &identity_path_clone,
        )
        .await
    ...
    async fn test_concurrent_loads() {
        ...
        // Create initial identity
        let original =
            p2p_ai_agents::core::identity::storage::load_or_create_identity_at(&identity_path)
                .await
                .expect("create identity");
